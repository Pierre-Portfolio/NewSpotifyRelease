...
| **Bon Plan** | `ComparePanel`, bleu-indigo | `spotifyplus_cmp_watch` | Ma liste · Promos (CheapShark — ⚠ `/deals` renvoie **une ligne par boutique** : regroupées par `gameID`, meilleure offre seule, vignette → tableau site/prix) · Bibliothèque Steam · Recherche jeux · Tous produits (IA + recherche web) |
