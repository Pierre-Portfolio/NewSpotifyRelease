...
| **Emploi** | `EmploiPanel`, `#57a0e0` | `spotifyplus_emploi` | 🎯 Critères de l'emploi rêvé (formulaire = **seule source de vérité**, `EMPLOI_CRIT_KEYS` = liste blanche écrite en localStorage) + 📋 Offres (The Muse + Remotive) filtrées dessus |
