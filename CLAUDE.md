...
| `MapsPanel` | **Section Maps** — vide pour le moment (placeholder « 🗺️ Section Maps — à venir »). Couleur `MAPS_COLOR = '#e6d53f'` (jaune, cran de l'arc-en-ciel). Onglet sous To do (desktop `maps` + mobile overflow) |
