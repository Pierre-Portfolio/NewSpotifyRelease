...
C'est un **hub perso** multi-sections : Musique (feed), Actu, Météo, Finance (+ Mes Actifs), Bon Plan, TV Time, Note, Santé, Vêtement, To do, Maps, Mot de passe, Remember/Alertes, Stats, League of Legends, GitHub/Speedrun.
...
### `APP_VERSION` (actuellement `'6.5.7'`)
