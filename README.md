...
- **⏸ En pause** : les séries dont tu as **suspendu le visionnage** — chacune a **▶ Reprendre le visionnage** (retour dans « En cours ») et **⏹ Arrêter le visionnage** (la série passe dans « Vus »)
