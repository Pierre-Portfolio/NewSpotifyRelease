...
| **🔐 Mot de passe** | Coffre chiffré AES-GCM 256 (PBKDF2 600 000 itérations), tags, réordonnancement, verrouillage automatique après 10 min. Chaque identifiant porte une **criticité** facultative (P1 → P5), affichée en pastille sur la fiche et filtrable, et peut porter une **date d'expiration** : la fiche affiche alors un ⏳ dès qu'il reste moins d'un mois, et un ⚠ rouge une fois la date passée — sans qu'il faille l'ouvrir |
