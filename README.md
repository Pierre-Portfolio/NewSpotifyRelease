...
- **« Stockage local saturé » ?** À propos → 📦 *Limite data* montre où part la place : espace utilisé, espace **encore libre** (mesuré sur ton navigateur, pas supposé) et la répartition module par module — plus la réserve navigateur, bien plus large, qui porte la base musicale et les pièces jointes des notes.
