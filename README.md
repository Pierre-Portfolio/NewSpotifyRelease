...
- **↥ Restaurer mes données** : réimporte une sauvegarde JSON exportée (complète **ou** partielle) — les dates de scan des artistes sont fusionnées (jamais régressées), les stats fusionnées prudemment, les to do / rappels / TV Time / Maps / coffre MDP remplacés par la sauvegarde s'ils y figurent (une copie de secours du coffre actuel est conservée)
