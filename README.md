...
- **↧ Exporter mes données** : section **repliable** (fermée par défaut) proposant **8 exports JSON séparés** — **Tous** (sauvegarde complète), **Artistes** (dates de scan + compteurs), **TV Time**, **To do**, **Maps**, **Mot de passe** (coffre **chiffré**, déchiffrable uniquement avec le mot de passe maître), **Remember** et **Stats** — pour ne rien perdre (les données ne vivent que sur cet appareil)
