...
| **🎮 Jeux** | 31 mini-jeux 100 % hors ligne (2048, Sudoku, Simon, Plox, Bounce, Doodle Jump, Crossy Road, Flappy, Motus, Démineur, Snake, Osu, Piano Tiles, Guitar Hero, Air Hockey, Blackjack, Poker, Flip 7, Puissance 4, Go, Morpion, Memory, Bataille navale, TierList, et des jeux de soirée à plusieurs sur le même téléphone) |
