...
| **🎮 Jeux** | 27 mini-jeux 100 % hors ligne (2048, Simon, Plox, Doodle Jump, Crossy Road, Flappy, Motus, Démineur, Osu, Piano Tiles, Guitar Hero, Air Hockey, Blackjack, Poker, Puissance 4, Go, Morpion, Memory, Bataille navale, TierList, et des jeux de soirée à plusieurs sur le même téléphone) |
