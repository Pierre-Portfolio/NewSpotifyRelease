...
| **🎬 TV Time** | Séries et films (TMDB), chaînes YouTube (onglets **▶️ YT** et **🩳 Short** séparés — une chaîne passe dans Short quand tu actives son « Garder uniquement les Shorts » ; vidéos et Shorts comptés séparément, lecteur plein écran avec file d'attente, **résumé IA de la vidéo + fil de questions** en bas de l'écran, barre ↕ pour partager la hauteur avec la vidéo), livres. Progression épisode par épisode, synchronisation quotidienne automatique |
