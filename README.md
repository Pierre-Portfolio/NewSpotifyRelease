...
| **💹 Finance** | Cours (crypto, indices, or, devises, actions) en mode Light ou Full, historique constitué jour après jour — **un relevé part tout seul à la connexion, une fois par jour, même si tu n'ouvres pas le module** (et même en mode 📴 hors ligne Spotify) —, calculatrice, tableau de bord BullRun, et **Mes Actifs** (lecture de ton classeur Google Drive) dont les courbes d'historique — les dernières, sous un bandeau **🤖 Proposé par l'IA**, sont des suggestions d'audit : cascade du mois (d'où vient la variation), composition du patrimoine net, crédit immobilier, économie mensuelle et taux d'épargne |
