...
- **Chiffrer tes sauvegardes** : À propos → ↧ *Exporter* → l'interrupteur **🔓/🔒** en tête. Le fichier de sauvegarde contient sinon **en clair** ton jeton GitHub et toutes tes clés d'API, et il part sur Dropbox / Drive / pCloud. Activé, une phrase de passe est demandée à chaque export et à chaque restauration (même chiffrement que le coffre de mots de passe). ⚠ Phrase oubliée = sauvegarde définitivement illisible.
