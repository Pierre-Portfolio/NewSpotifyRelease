...
- Export / import JSON, complet ou par section ; **Dropbox, Google Drive, pCloud** en un bouton ; **sauvegarde Dropbox quotidienne** optionnelle (À propos → 🤖 Lancement automatique).
