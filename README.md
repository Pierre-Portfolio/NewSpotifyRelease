...
- **⚙️ Paramétrage des modules** : section **repliable** avec un **interrupteur par module** (Historique, Artistes, Actu, Météo, Finance, Comparé, TV Time, To do, Maps, Mot de passe, Remember, Stats) — activer/désactiver un module **fait apparaître/disparaître son onglet** en direct (desktop et mobile). Le réglage est inclus dans l'export/import (et la sync Dropbox/Drive)
...
### Comparé
- Section **Comparé** dédiée (titre en cyan-vert), **entre Finance et TV Time** — comparateur de prix, désactivable dans le Paramétrage
