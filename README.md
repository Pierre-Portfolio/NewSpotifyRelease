...
- **Numéro de version** affiché en gris sous le bouton « Purger les écoutes » **et en badge sur la page de connexion** (à la place de « Zéro backend » ; actuellement `Version 5.9.3`) — basé sur le nombre de commits du projet (format `MAJ.MIN.U` : derniers chiffres = patch/minor, le reste = major ; ex. 278 commits → `2.7.8`, 1001 → `10.0.1`)
