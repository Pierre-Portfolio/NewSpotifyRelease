...
### Sport
🏋️ **Suivi d'entraînement 100 % local** : un collapse par **partie du corps** (Full body, Dos, Pecs, Biceps, Triceps, Jambe), chacun listant les **exercices possibles** sous forme de tuiles. **Touche un exercice pour le marquer fait** (il se grise), et le bouton **↺ Réinitialiser** remet la partie à zéro. Ton avancement est mémorisé.
